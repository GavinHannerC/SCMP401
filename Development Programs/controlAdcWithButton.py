...
print('Welcome to the GC Analog-to-Digital Converter')
print('When you are ready, press the button on the breadboard to start recording data')
print('Press the button a second time to finish recording')
...
print('Your data is in a CSV file named:')
print(csvName)
